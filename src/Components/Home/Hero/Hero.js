    ...
    <div className="">
      <div className="">
        <div className="flex flex-wrap">
          <div
            className="w-full sm:w-1/2 md:w-1/3  h-[450px] bg-repeat-x bg-bottom"
            style={{
              backgroundImage: `url(${bg1})`,
            }}
          >
            <div className="">
              <div className="text-white bg-[#2E7FDA] bg-opacity-80  h-[450px]">
                  ...
                  <div className="p-10">
                    <div>
                      ...
                      <input
                        ...
                        className="input w-[262px] text-xs bg-white mb-4 text-gray-500"
                      />
                    </div>
                    <div>
                      <h4 className="mb-4 font-bold flex">
                      ...
                      <select className="select w-[262px] bg-white text-gray-500">
                    ...
                    <div>
                      ...
                      <select className="select w-[262px] bg-white text-gray-500">
                        ...
                        <option>
                          সংযুক্ত আরব আমীরাত (United Arab Emirates)
                        </option>
                    ...
                    <button className="btn btn-warning mt-4">অনুসন্ধান</button>
                  </div>
                </div>
              </div>
            </div>
          </div>
          <div className="w-full sm:w-1/2 md:w-1/3 h-[450px] bg-white">
            <div className="">
              <Swiper
                spaceBetween={30}
                centeredSlides={true}
          ...
          >
            <div className="">
              <div className="text-white bg-[#2E7FDA] bg-opacity-80  h-[470px]">
                <div className="flex flex-row justify-start">
                  <div className="p-4">
                    <div>
                      <h3 className="mb-3 font-bold mt-4">
                        বিভিন্ন দেশে কর্মী প্রয়োজন
                      </h3>
                      <ul>
                        <li className="mb-3 font-thin text-gray-300">
